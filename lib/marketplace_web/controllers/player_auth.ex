defmodule MarketplaceWeb.PlayerAuth do
  import Plug.Conn
  ...
  def log_in_player(conn, player, params \\ %{}) do
    ...
    |> put_session(:live_socket_id, "player_sessions:#{Base.url_encode64(token)}")
  ...
  def log_out_player(conn) do
    ...
    player_token && Accounts.delete_session_token(player_token)

    if live_socket_id = get_session(conn, :live_socket_id) do
      MarketplaceWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end

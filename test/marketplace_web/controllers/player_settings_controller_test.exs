defmodule MarketplaceWeb.PlayerSettingsControllerTest do
  ...
  describe "GET /player/settings" do
  ...
  describe "PUT /player/settings (change password form)" do
  ...
  describe "PUT /player/settings (change email form)" do
    @tag :capture_log
  ...
  describe "GET /player/settings/confirm_email/:token" do

defmodule MarketplaceWeb.PlayerResetPasswordControllerTest do
  ...
  describe "GET /player/reset_password" do
  ...
  describe "POST /player/reset_password" do
    @tag :capture_log
  ...
  describe "GET /player/reset_password/:token" do
  ...
  describe "PUT /player/reset_password/:token" do
    setup %{player: player} do
      token =
        extract_player_token(fn url ->
          Accounts.deliver_player_reset_password_instructions(player, url)

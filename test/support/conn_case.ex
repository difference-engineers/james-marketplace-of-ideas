defmodule MarketplaceWeb.ConnCase do
  ...
  @doc """
  Setup helper that registers and logs in player.
  ...
  def register_and_log_in_player(%{conn: conn}) do
    player = Marketplace.AccountsFixtures.player_fixture()
  ...
  def log_in_player(conn, player) do
    token = Marketplace.Accounts.generate_player_session_token(player)

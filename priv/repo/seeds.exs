...
{:ok, textile_resource} = Marketplace.Game.create_resource(%{name: "Textile", export: 4, import: 8, luxury_export: 12, luxury_import: 24})
...
{:ok, warship_resource} = Marketplace.Game.create_resource(%{name: "Warship", export: 5, guildable: false, importable: false})
